        ...
        for service in data.keys():
            try:
                ...
                if mean(service_value['sysdig_container_memory_limit_used_percent']) > 80:
                    ...
                    modify_memory_value(f'./{service}-java/manifests-openshift/deploy-{service}-java.yaml', 'd')
                ...
                if mean(service_value['sysdig_container_cpu_quota_used_percent']) > 80:
                    ...
                    modify_cpu_value(f'./{service}-java/manifests-openshift/deploy-{service}-java.yaml', 'i')
                    ...
                    modify_cpu_value(f'./{service}-java/manifests-openshift/deploy-{service}-java.yaml', 'd')
                else:
